...
import { NavLink, useNavigate } from "react-router-dom";
import { LogOutIcon, UserIcon, KeyRoundIcon, HomeIcon, BookOpen, ShieldIcon, BadgeCheckIcon } from "lucide-react";
import { useUser } from "../../context/UserContext"; 
import "../../styles/Header.css";
    ...
    <header className="app-header">
      <div className="header-left">
        <NavLink to="/" className="logo-text">
          <HomeIcon size={20} className="logo-icon" />
          <span className="brand-name">Kijane</span>
        </NavLink>
        ...
        <NavLink to="/courses" className="header-link">
          <BookOpen size={18} /> <span>Kurse</span>
        </NavLink>
      ...
      <div className="header-right">
        <NavLink to="/admin/settings/profile" className="header-link">
          <UserIcon size={18} /> <span>Mein Profil</span>
          <span className="header-user">
            <UserIcon size={16} /> {user?.username || "Nutzer"}
          </span>
        </NavLink>
