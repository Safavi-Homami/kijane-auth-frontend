...
const handleJsonTextareaScroll = () => {
  ...
  const loadExample = async () => {
    ...
    try {
      ...
      // Sicherheitsnetz:
      // Falls die Beispiel-Datei versehentlich noch finalExam enthält,
      // entfernen wir sie vor der Anzeige.
...
const jsonLineNumbersStyle = {
 ...
 const jsonTextareaStyle = {
    ...
    <div className="page-background">
      <div className="container">
        <div className="page-hero">
          <div className="page-hero-kicker">Trainer / Admin</div>
          <h1>Course Blueprint Import</h1>
          <p>
            Importiere einen Kurs aus einer JSON-Blueprint-Struktur. Die
            Abschlussprüfung wird nicht automatisch erzeugt, sondern später
            manuell durch den Trainer erstellt.
          </p>
        </div>
            ...
            {copyMessage && (
              <div
                style={{
                  textAlign: "center",
                  fontWeight: 700,
                  color: copyMessage.includes("✅") ? "#86efac" : "#fecaca",
                  marginBottom: "12px",
                }}
              >
                {copyMessage}
  ...
  >
    {loading ? "Importiere..." : "Blueprint importieren"}
  </button>
</div>
          {repairMessage && (
            <div
              ...
              {blueprintAnalysis.parseErrorDetails?.tips?.length > 0 && (
                ...
                >
                  ...
                  <ul style={{ margin: 0, paddingLeft: "20px" }}>
                    {blueprintAnalysis.parseErrorDetails.tips.map((tip, index) => (
                      <li key={index}>{tip}</li>
                    ))}
                  </ul>
                </div>
